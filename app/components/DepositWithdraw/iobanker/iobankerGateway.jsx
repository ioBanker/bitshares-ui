...
class iobankerGateway extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            action: props.viewSettings.get(`iobankerAction`, "deposit")
        };
    }

    _getActiveCoin(props, state) {
        let cachedCoin = props.viewSettings.get(
            `activeCoin_iobanker_${state.action}`,
            null
        );
    ...
    onSelectCoin(e) {
        ...
        let setting = {};
        setting[`activeCoin_iobanker_${this.state.action}`] = e.target.value;
    ...
    changeAction(type) {
        ...
        SettingsActions.changeViewSetting({[`iobankerAction`]: type});
    }
                ...
                {!coin ? null : (
                    <div>
                        <div style={{marginBottom: 15}}>
                            ...
                            <div>
                                <Translate content="gateway.iobanker.support_block" />
                                <br />
                                <br />
                                <a
                                    href={supportUrl}
