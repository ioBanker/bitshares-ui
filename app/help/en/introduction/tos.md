...
BitShares is a decentralized permissionless “Blockchain As Organization” (BAO) network; a powerful beyond Bitcoin innovation in which its core asset BTS is being utilized as an organization proof of stake and utility token to satisfy Blockchain users financial means in a form of smart transactions fully stored on each node within its decentralized network. 
