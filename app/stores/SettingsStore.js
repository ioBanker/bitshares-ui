...
class SettingsStore {
    ...
    init() {
        return new Promise(resolve => {
            ...
            let marketID9 = "HONEST.ETH" + "_" + "BTS";
            let marketID3 = "XBTSX.USDT" + "_" + "HONEST.USD";
            let marketID4 = "RUDEX.BTC" + "_" + "HONEST.BTC";
            let marketID7 = "HONEST.BTC" + "_" + "HONEST.USD";
            let marketID8 = "HONEST.USD" + "_" + "HONEST.BTC";
            ...
            this.starredMarkets = this.starredMarkets.set(marketID4, {
                quote: "RUDEX.BTC",
                base: "HONEST.BTC"
            });

            this.starredMarkets = this.starredMarkets.set(marketID7, {
                quote: "HONEST.BTC",
                base: "HONEST.USD"
            });

            this.starredMarkets = this.starredMarkets.set(marketID8, {
                quote: "HONEST.USD",
                base: "HONEST.BTC"
            });

            this.starredMarkets = this.starredMarkets.set(marketID10, {
                quote: "BTS",
                base: "HONEST.BTC"
            });

            this.starredMarkets = this.starredMarkets.set(marketID11, {
                quote: "BTS",
                base: "HONEST.USD"
            });

            this.starredMarkets = this.starredMarkets.set(marketID12, {
                quote: "IOB.XRP",
                base: "BTS"
            });
            ...
            this.starredMarkets = this.starredMarkets.set(marketID17, {
                quote: "TWENTIX",
                base: "BTS"
            });
